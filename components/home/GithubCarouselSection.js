    ...
    return (
        <Section title="Latest Projects" className={`${styles["container"]} pb-8 md:pb-12`}>
            <div className="glide-wrapper pb-12">
                <div className="splide" ref={carouselRef}>
                    
                    <div className="splide__arrows hidden md:block" data-glide-el="controls">
                        <button className="splide__arrow splide__arrow--left" data-glide-dir="<" aria-label="Left Arrow">
                            <AiOutlineArrowLeft className="text-black dark:text-white"/>
                        </button>
                    </div>

                    <div className="splide__track" data-glide-el="track">
                    ...
                    <div className="splide__arrows hidden md:block" data-glide-el="controls">
                        <button className="splide__arrow splide__arrow--right" data-glide-dir=">" aria-label="Right Arrow">
                            <AiOutlineArrowRight className="text-black dark:text-white"/>
                        </button>
                    </div>
                    <div className="splide__bullets bottom-0" data-glide-el="controls[nav]">
                        {githubProjects.map((_, index) => (
                            <button className="splide__bullet" data-glide-dir={`=${index}`} key={index} aria-label={`Slide ${index}`}></button>
                        ))}
                    </div> 
                </div> 
            </div>
